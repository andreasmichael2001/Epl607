...
def render_frame(angle, frame_id):
    ...
    material = Material([80, 130, 255], [140, 140, 140], 16, "both")
    light = Light([0, 2, 5], np.array([700, 700, 700]))
    fill = Light([0, -1.5, 4.5], np.array([300, 300, 300]))
...
if __name__ == "__main__":
    ...
    print("ffmpeg -framerate 30 -i frames/frame_%03d.png -c:v libx264 -pix_fmt yuv420p output.mp4")